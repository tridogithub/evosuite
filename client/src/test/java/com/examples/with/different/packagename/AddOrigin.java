...
public class AddOrigin {
    ...
    public AddOrigin(int currentMonth, int currentDay, int currentYear) {
        this.currentYear = currentYear;
        this.currentMonth = currentMonth;
        this.currentDay = currentDay;
    }

    public AddOrigin(int currentMonth, int currentDay, int currentYear, int ERA) {
        this.currentYear = currentYear;
        this.currentMonth = currentMonth;
        this.currentDay = currentDay;
        if (ERA != 0) {
    ...
    public String addOld(int field, int amount) {
