...
public class Add {
    ...
    public Add(int currentYear, int currentMonth, int currentDay) {
        this.currentYear = currentYear;
        this.currentMonth = currentMonth;
        this.currentDay = currentDay;
    }

    public Add(int currentYear, int currentMonth, int currentDay, int ERA) {
        this.currentYear = currentYear;
        this.currentMonth = currentMonth;
        this.currentDay = currentDay;
        if (ERA != 0) {
    ...
    public String add(int field, int amount) throws ParseException {
